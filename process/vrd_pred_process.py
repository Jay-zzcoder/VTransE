...
train_file_path =  '/home/zzuo/hw/sg_dataset/annotations_train.json'
test_file_path = cfg.DIR + '/home/zzuo/hw/sg_dataset/annotations_test.json'
file_path = [train_file_path, test_file_path]
train_image_path = cfg.DIR + '/home/zzuo/hw/sg_dataset/sg_train_images/'
test_image_path = cfg.DIR + '/home/zzuo/hw/sg_dataset/sg_test_images/'
...
for r in range(2):
	...
	with open(file_path_use,'r') as f:
		...
		for image_id in range(len_img):
			...
			roidb_temp = {}
			image_full_path = image_path_use + list(image_name)[image_id]
